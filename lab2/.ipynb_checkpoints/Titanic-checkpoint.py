...
(train_data, train_targets), (test_data, test_targets) = (train.input_properties[train_idx],train.labels[train_idx]),(train.input_properties[test_idx],train.labels[test_idx])
